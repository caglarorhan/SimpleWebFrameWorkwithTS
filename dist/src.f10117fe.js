...
function () {
  function UserForm(parent, model) {
    ...
    this.onSetNameClick = function () {
      var input = _this.parent.querySelector('#new-name');
...
function () {
  ...
  ApiSync.prototype.save = function (data) {
    ...
    if (id) {
      //put
      return axios_1.default.put(this.rootUrl + "/" + id, data); // an update process
    } else {
      //post
      return axios_1.default.post(this.rootUrl, data); // an insert process for new record
    }
  };
...
},{"./views/UserForm":"src/views/UserForm.ts","./models/User":"src/models/User.ts"}],"../../../../../Users/cagla/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../../../Users/cagla/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/index.ts"], null)
